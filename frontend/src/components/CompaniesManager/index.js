        ...
        {(values, setValues) => (
          <Form className={classes.fullWidth}>
            <Grid spacing={2} justifyContent="flex-end" container>
              ...
              <Grid xs={12} sm={6} md={2} item>
                <FormControl margin="dense" variant="outlined" fullWidth>
                  <InputLabel htmlFor="status-selection">Campagnes</InputLabel>
                  <Field
                    as={Select}
                    ...
                    margin="dense"
                  >
                    <MenuItem value={true}>Ingeschakeld</MenuItem>
                    <MenuItem value={false}>Uitgeschakeld</MenuItem>
                  </Field>
                </FormControl>
              </Grid>
              <Grid xs={12} sm={6} md={2} item>
              ...
              <Grid xs={12} sm={6} md={2} item>
                <FormControl margin="dense" variant="outlined" fullWidth>
                  ...
                  <Field
                    ...
                    margin="dense"
                  >
                    <MenuItem value="MENSAL">Maandelijks</MenuItem>
...
export function CompaniesManagerGrid(props) {
  ...
  const renderStatus = (row) => {
    return row.status === false ? "Nee" : "Ja";
  };
  ...
  const renderCampaignsStatus = (row) => {
    if (
      ...
      if (setting) {
        return setting.value === "true" ? "Ingeschakeld" : "Uitgeschakeld";
      }
    }
      ...
      >
        <TableHead>
          <TableRow>
            ...
            <TableCell align="left">Campagnes</TableCell>
            <TableCell align="left">Status</TableCell>
            <TableCell align="left">Gemaakt Op</TableCell>
            <TableCell align="left">Vervaldatum</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {records.map((row, key) => (
...
export default function CompaniesManager() {
  ...
  const loadPlans = async () => {
    ...
    try {
      ...
      toast.error("Kon de lijst met bedrijven niet laden");
    }
    setLoading(false);
  };
  ...
  const handleSubmit = async (data) => {
    ...
    try {
      ...
      toast.error(
        "Bewerking kon niet worden uitgevoerd. Controleer of er al een bedrijf bestaat met dezelfde naam of dat alle velden correct zijn ingevuld"
      );
    }
    setLoading(false);
  };
  ...
  return (
    <Paper className={classes.mainPaper} elevation={0}>
      ...
      >
        Wilt u dit bedrijf echt verwijderen?
      </ConfirmationModal>
    </Paper>
  );
}
